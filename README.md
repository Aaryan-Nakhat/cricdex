...
| `rules` | planned P0 | Natural-language Q&A over all cricket rulebooks (MCC Laws + ICC Playing Conditions Test/ODI/T20I + IPL + Hundred + BBL + SA20 + ILT20 + PSL + MLC + CPL + LPL + WPL + Domestic). |
...
| `fantasy` | planned P1 | Dream11-style constraint-solved XI optimizer with crowd-contrarian signal. |
...
| `commentary_translate` | planned P1 | Live commentary translation into Hindi/Tamil/Bengali/Urdu/Sinhala. |
