...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    body: (
      <>
        Pick an active IPL player and find others of the <em>same mould</em> across six pools:{" "}
        ...
        Africa), <strong>CPL</strong> (West Indies) and the <strong>T20 Blast</strong> (England). Matches share the same role (and seam/spin type
  ...
  },
  {
    ...
    body: (
      <>
        ...
        players plus free agents from the <strong>BBL</strong>, <strong>SA20</strong>,{" "}
        <strong>CPL</strong> and <strong>T20 Blast</strong> (overseas) and the <strong>SMAT</strong>{" "}
