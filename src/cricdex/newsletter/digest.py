...
Output: `data/newsletters/<date>_<collection>.md`. The digest is a
flat Markdown file the user previews, pipes, or pastes into any
delivery channel. CricDex is a terminal-first tool — bring your own
mailer if you want it shipped.
"""
